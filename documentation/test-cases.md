...
### **TC-11 Некорректный ввод ширины (буквы)**

***Priority***: P1
***Automation***: NO (в работе)
...
**TC-13 Генерация превью с валидными данными без console ошибок**
...
### **TC-14 Выбор ширины блока не влияет на превью при активированном "на всю ширину контейнера"**
...
2. Ввести валидное значение ширины (значения от 230 до 1020)
